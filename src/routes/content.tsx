    ...
    <div className="mx-auto max-w-[1300px]">
      ...
      <div className="card-soft overflow-hidden mb-6">
        <div className="grid md:grid-cols-2">
          <div className="h-64 md:h-auto bg-gradient-to-br from-primary via-brand to-accent" />
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4">
        {content.map((c) => (
          <div key={c.id} className="card-soft p-4 hover:shadow-elevated transition-shadow cursor-pointer">
            <div className="h-32 rounded-md bg-gradient-to-br from-accent to-brand-soft mb-3 grid place-items-center">
